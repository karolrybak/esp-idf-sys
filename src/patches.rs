...
// We provide a quick and very hacky implementation
mod atexit;
#[cfg(feature = "std")]
mod lstat;
mod realpath;
...
#[allow(dead_code)]
pub struct PatchesRef(*mut core::ffi::c_void, *mut core::ffi::c_void, *mut core::ffi::c_void);
...
pub fn link_patches() -> PatchesRef {
    ...
    let realpath = realpath::link_patches();

    PatchesRef(lstat, atexit, realpath)
}
